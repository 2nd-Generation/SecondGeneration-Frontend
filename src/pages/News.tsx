  ...
  const newsData: NewsItem[] = [
    {
      ...
      content: `<h3 class="text-xl font-bold text-yellow-400 mb-6 text-center">이벤트 자세히 보기</h3>
    ...
    },
    {
      ...
      content: `<h3 class="text-xl font-bold text-yellow-400 mb-6 text-center">경기 자세히 보기</h3>
    ...
    },
    {
      ...
      content: `<h3 class="text-xl font-bold text-yellow-400 mb-6 text-center">교재 자세히 보기</h3>
    ...
    },
    {
      ...
      content: `<h3 class="text-xl font-bold text-yellow-400 mb-6 text-center">스폰서 자세히 보기</h3>
    ...
    },
    {
      ...
      content: `<h3 class="text-xl font-bold text-yellow-400 mb-6 text-center">프로모션 자세히 보기</h3>
    ...
    },
    {
      ...
      content: `<h3 class="text-xl font-bold text-yellow-400 mb-6 text-center">모집 자세히 보기</h3>
    ...
    },
    {
      ...
      content: `<h3 class="text-xl font-bold text-yellow-400 mb-6 text-center">시스템 자세히 보기</h3>
      ...
      <main className="container mx-auto px-6 py-12 md:py-24">
        <section className="mb-16">
          <h1 className="text-5xl md:text-6xl font-black text-white mb-8 text-center">
            <span className="text-yellow-400">SGeA</span> 소식
          </h1>
        ...
        <section className="mb-12">
          <div className="flex flex-wrap justify-center gap-4">
            {categories.map((category) => (
              <span
                key={category}
                className="px-6 py-3 bg-gray-800 text-white rounded-full hover:bg-yellow-400 hover:text-black transition-colors cursor-pointer"
              >
                {category}
              </span>
            ))}
          ...
          {newsData.map((news) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <h3 className="text-lg font-bold mb-4 text-white group-hover:text-yellow-400 transition-colors">
                  {news.title}
                </h3>
