    ...
    <div className="bg-gray-900 text-white font-['Noto_Sans_KR']">
      ...
      <main className="container mx-auto px-6 py-12 md:py-24">
        ...
        <section id="contact" className="mb-20 text-center">
          ...
          <a
            href="#"
            className="inline-block px-10 py-4 rounded-full text-gray-900 font-bold bg-yellow-400 hover:bg-yellow-500 transition-all duration-300 text-xl shadow-lg transform hover:scale-105"
          >
            상담 신청하기
          </a>
        </section>
