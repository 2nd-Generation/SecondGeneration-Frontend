      ...
      <main className="container mx-auto px-6 py-12 md:py-24 space-y-20">
        ...
        <section>
          <h1 className="text-5xl md:text-6xl font-black mb-8 text-center">
            <span className="text-purple-500">SGEA</span> 소개
          </h1>
          <div className="bg-gray-800 p-8 md:p-12 rounded-2xl shadow-xl">
            ...
            <div className="grid md:grid-cols-2 gap-8 my-12">
              <div className="bg-gray-700 p-6 rounded-xl">
                <h3 className="text-xl font-bold text-purple-500 mb-4">아카데미 비전</h3>
              ...
              <div className="bg-gray-700 p-6 rounded-xl">
                <h3 className="text-xl font-bold text-purple-500 mb-4">교육 철학</h3>
                <p className="text-gray-300">
            ...
            {/* 강조 문구 */}
            <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-8 rounded-xl text-center">
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="bg-gray-800 p-6 rounded-xl flex items-center">
              <div className="bg-purple-500 text-white font-black text-lg px-4 py-2 rounded-full mr-6">2024</div>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-xl text-center transition-transform duration-300 hover:scale-105">
              <h3 className="text-2xl font-bold text-purple-500 mb-4">멘탈 코칭</h3>
              <p className="text-gray-300">
                스트레스 관리와 자신감 향상을 위한 전문 상담·심리 프로그램을 제공합니다.
              </p>
            </div>
            <div className="bg-gray-800 p-6 rounded-xl text-center transition-transform duration-300 hover:scale-105">
              <h3 className="text-2xl font-bold text-purple-500 mb-4">팀워크 트레이닝</h3>
              <p className="text-gray-300">
                기술적 능력뿐 아니라 팀워크와 커뮤니케이션 역량을 강화하는 훈련을 진행합니다.
              </p>
            </div>
            <div className="bg-gray-800 p-6 rounded-xl text-center transition-transform duration-300 hover:scale-105">
              <h3 className="text-2xl font-bold text-purple-500 mb-4">커리어 상담</h3>
              <p className="text-gray-300">
