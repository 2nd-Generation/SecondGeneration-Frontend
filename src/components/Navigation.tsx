        ...
        <div className="absolute left-1/2 transform -translate-x-1/2">
          <Link to="/" className="group flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
            <div className="relative">
              ...
              <img src="/logo.png" alt="SGEA 로고" className="relative w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 object-contain group-hover:scale-110 transition-transform duration-300" />
            </div>
